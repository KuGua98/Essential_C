...
int ex1_7()
{
  ifstream in_file("C:\\Users\\1\\Desktop\\pzx\\C++\\exercise\\Project1\\Project1\\text.txt");
  if (!in_file)
  {
	cerr << "oops! unable to open input file\n"; return -1;
  }

  ofstream out_file("C:\\Users\\1\\Desktop\\pzx\\C++\\exercise\\Project1\\Project1\\text.sort");
  if (!out_file)
  {
	cerr << "oops! unable to open output file\n"; return -2;
  }
